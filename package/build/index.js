...
function CreatePortalWithProps(Component, props, containerId, setInstance, getStyleForContainer) {
    ...
    const portal = ReactDOM.createPortal(React__default["default"].createElement(Component, Object.assign({}, mergedProps)), container);
...
class NSGridReact extends NSBaseReactComponent {
    ...
    render() {
        ...
        return (React__namespace.createElement("div", { style: this.__getStyleForContainer(), ref: (e) => { this.__container = e; } }, this.state.dynamicComponents.map((portal, index) => (React__namespace.createElement(React__namespace.Fragment, { key: index }, portal)))));
    }
...
class NSMessageBoxReact extends NSBaseReactComponent {
    ...
    render() {
        var _a;
        return (React__namespace.createElement("div", { style: this.__getStyleForContainer(), ref: (e) => { this.__container = e; } }, this.__objNSPanel && ((_a = this.state.dynamicComponents) === null || _a === void 0 ? void 0 : _a.map((portal, index) => (React__namespace.createElement(React__namespace.Fragment, { key: index }, portal))))));
    }
    getElement() {
        return this.__container;
    }
...
const NSNavigationReactComponent = (props, ref) => {
    ...
    const nsNavigationRef = React.useRef(null);
    const containerRef = React.useRef(null);
    const nsUtilRef = React.useRef(new NSUtil$7());
    const dataSourceRef = React.useRef(props.dataSource || ((_a = props.setting) === null || _a === void 0 ? void 0 : _a.dataSource) || []);
    const settingRef = React.useRef(nsUtilRef.current.cloneObject(props.setting, true));
    React.useState(false);
    const [hasDataSource, setHasDataSource] = React.useState(false);
    const arrEvents = [
    ...
    return (React__default["default"].createElement("div", { style: getStyleForContainer(), ref: containerRef }));
};
const NSNavigationReact = React.forwardRef(NSNavigationReactComponent);
...
const NSHorizontalNavigationReactComponent = (props, ref) => {
    ...
    const nsNavigationRef = React.useRef(null);
    const containerRef = React.useRef(null);
    const nsUtilRef = React.useRef(new NSUtil$6());
    const dataSourceRef = React.useRef(props.dataSource || ((_a = props.setting) === null || _a === void 0 ? void 0 : _a.dataSource) || []);
    const settingRef = React.useRef(nsUtilRef.current.cloneObject(props.setting, true));
    React.useState(false);
    const [hasDataSource, setHasDataSource] = React.useState(false);
...
const NSHorizontalNavigationReact = React.forwardRef(NSHorizontalNavigationReactComponent);
...
exports.NSAjax = NSAjax;
exports.NSAjaxReact = NSAjaxReact;
exports.NSCalendar = NSCalendar;
exports.NSCalendarReact = NSCalendarReact;
exports.NSConsole = NSConsole;
exports.NSContainerBase = NSContainerBase;
exports.NSDashboard = NSDashboard;
exports.NSDashboardReact = NSDashboardReact;
exports.NSDatePicker = NSDatePicker;
exports.NSDatePickerReact = NSDatePickerReact;
exports.NSDateUtil = NSDateUtil;
exports.NSDividerBox = NSDividerBox;
exports.NSEditor = NSEditor;
exports.NSEditorReact = NSEditorReact;
exports.NSEvent = NSEvent;
exports.NSExport = NSExport;
exports.NSExpressionEvaluator = NSExpressionEvaluator;
exports.NSGrid = NSGrid;
exports.NSGridReact = NSGridReact;
exports.NSHorizontalNavigation = NSHorizontalNavigation;
exports.NSHorizontalNavigationReact = NSHorizontalNavigationReact;
exports.NSList = NSList;
exports.NSMessageBox = NSMessageBox;
exports.NSMessageBoxReact = NSMessageBoxReact;
exports.NSMultiSelectDropdown = NSMultiSelectDropdown;
exports.NSMultiselectDropdownReact = NSMultiselectDropdownReact;
exports.NSNavigation = NSNavigation;
exports.NSNavigationReact = NSNavigationReact;
exports.NSNumericTextBox = NSNumericTextBox;
exports.NSPagination = NSPagination;
exports.NSPanel = NSPanel;
exports.NSPanelReact = NSPanelReact;
exports.NSPinTip = NSPinTip;
exports.NSRouter = NSRouter;
exports.NSScroller = NSScroller;
exports.NSSvg = NSSvg;
exports.NSSvgShapes = NSSvgShapes;
exports.NSTabNavigator = NSTabNavigator;
exports.NSTabNavigatorReact = NSTabNavigatorReact;
exports.NSTableRowMover = NSTableRowMover;
exports.NSTextBox = NSTextBox;
exports.NSTextBoxReact = NSTextBoxReact;
exports.NSTouchToMouse = NSTouchToMouse;
exports.NSUtil = NSUtil;
exports.NSVirtualScroll = NSVirtualScroll;
exports.NSXlsxExport = NSXlsxExport;
